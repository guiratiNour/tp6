...
public class CategorieDaoImpl implements ICategorieDao { 
	// TP6_JEE à replacer par votre persistence unit, consultez votre //fichier persistence.xml <persistence-unit name="TP6_JEE"> 
	private EntityManager entityManager=JPAutil.getEntityManager("TP6_JEE"); 
 
 @Override  public Categorie save(Categorie cat ) {   
 ...
 @Override  public List<Categorie> getAllCategories() {
